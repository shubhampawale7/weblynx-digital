      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-24 gap-8">
          ...
          <p className="text-xl text-brand-light-blue dark:text-brand-gray max-w-sm font-light leading-relaxed">
            ...
            engineered for market leaders and precision brands.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          ...
          <nav
            aria-label="Featured projects selection"
          ...
          >
            <div className="relative group">
              ...
              <div
                className="relative aspect-[16/10] rounded-b-3xl overflow-hidden border border-gray-200 dark:border-white/10 shadow-2xl"
                id="project-viewport"
              >
                <AnimatePresence mode="wait">
                  ...
                  >
                    <img
                      ...
                      alt={`Full-stack project showcase: ${featuredProjects[activeIndex]?.title}`}
                    ...
                    <div className="absolute inset-0 bg-brand-dark/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center backdrop-blur-sm">
                      <Link
                        to="/our-work"
                        aria-label={`View details for ${featuredProjects[activeIndex]?.title}`}
                      ...
                      >
                        Explore Project <FiExternalLink aria-hidden="true" />
                      </Link>
                    </div>
                  </motion.div>
                </AnimatePresence>
...
const ProjectListItem = ({ project, isActive, setActiveIndex, index }) => (
  <article
    className="relative py-10 border-b border-gray-100 dark:border-white/5 cursor-pointer group focus-within:ring-2 focus-within:ring-brand-accent outline-none"
