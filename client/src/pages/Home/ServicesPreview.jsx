...
const servicesData = [
  {
    ...
    tags: ["MERN Stack", "Scalable"],
    description:
      "Bespoke engineering solutions built for high-performance business logic and complex enterprise workflows.",
  ...
  },
  {
    ...
    tags: ["iOS Development", "Android"],
    description:
      "Seamless native and cross-platform mobile experiences engineered for maximum global market reach.",
  ...
  },
  {
    ...
    tags: ["Node.js", "React"],
    description:
      "Unified engineering across the entire stack, from high-fidelity UI mastery to robust server stability.",
  ...
  },
  {
    ...
    Icon: FiTrendingUp,
    title: "SEO & Growth",
    tags: ["Algorithms", "Rank"],
    description:
      "Data-driven organic strategies and technical SEO audits designed to dominate search engine result grids.",
  ...
  },
  {
    ...
    tags: ["Custom UI", "PHP"],
    description:
      "Elegant, manageable, and lightning-fast WordPress solutions engineered without technical debt or bloat.",
      ...
      <div className="container mx-auto px-6">
        ...
        <header className="flex flex-col md:flex-row justify-between items-end mb-20 gap-8">
          ...
          >
            ...
            <div
              className="w-1.5 h-1.5 rounded-full bg-green-500 animate-pulse shadow-[0_0_10px_green]"
              aria-hidden="true"
            />
          </motion.div>
        </header>
...
const ServiceCard = ({ service, index }) => (
  ...
  >
    <div className="flex justify-between items-start mb-16 relative z-10">
      ...
      <div className="flex gap-2" aria-label="Technology Stack">
