...
const servicesData = [
  {
    ...
    link: "/services#custom-web-apps", // Updated anchor link
  },
  {
    icon: "🌐",
...
const ServicesPreview = () => {
  // ... (rest of the component, no other changes needed here)
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {servicesData.map((service, index) => (
            <motion.div
              ...
              className={`relative p-8 rounded-xl shadow-lg flex flex-col items-center text-center
                          ${
                            isDark
