...
const BlogListingPage = () => {
  ...
  return (
    <>
      <Seo
        title="Engineering Insights & Tutorials | Weblynx Infotech Blog"
        description="Expert engineering insights, MERN stack tutorials, and digital strategy breakdowns from the Weblynx Infotech team."
        keywords="MERN stack blog, software engineering insights, React tutorials, Weblynx Infotech"
      />
      ...
      >
        ...
        <header className="container mx-auto px-6 mb-20">
          <div className="flex flex-col md:flex-row justify-between items-end gap-8 border-b border-gray-100 dark:border-white/5 pb-12">
            ...
            <div
              className="hidden md:flex flex-col items-end opacity-20 font-mono text-[10px] uppercase tracking-widest"
              aria-hidden="true"
            >
