  ...
  return (
    ...
    >
      ...
      <section className="py-20 sm:py-24 text-center">
        ...
        >
                   {" "}
          <h1 className="text-5xl md:text-7xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-blue-500 dark:from-purple-400 dark:to-cyan-400">
                        Insights & Ideas          {" "}
          </h1>
                   {" "}
          <p className="text-lg md:text-xl mt-4 max-w-2xl mx-auto text-gray-600 dark:text-gray-400">
                        Our expert analysis on technology, design, and the
            ...
            {filteredPosts.map((post) => (
              ...
              >
                ...
                <Link to={`/blog/${post.slug}`} className="group block">
                  ...
                                   {" "}
                  <h3 className="text-xl font-bold mb-3 group-hover:text-blue-600 dark:group-hover:text-purple-400 transition-colors">
                                        {post.title}                 {" "}
                  </h3>
                                   {" "}
