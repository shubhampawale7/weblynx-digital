...
import { Link } from "react-router-dom"; // Import Link for navigation in footer
import { FaLinkedinIn, FaGithub, FaInstagram } from "react-icons/fa"; // Import updated social media icons
  ...
  return (
    <footer
      className={`py-8 px-4 sm:px-8 mt-auto transition-colors duration-300 ${
        // Adjusted horizontal padding for responsiveness
    ...
    >
      <div className="container mx-auto text-center">
        ...
        {/* Social Media Links - Now with your specific links and Instagram */}
        <div className="flex justify-center space-x-4 sm:space-x-6 mb-6 text-xl sm:text-2xl">
          <a
            href="https://www.linkedin.com/in/shubhampawale/" // Your LinkedIn URL
            target="_blank"
          ...
          <a
            href="https://github.com/shubhampawale7" // Your GitHub URL
            target="_blank"
            rel="noopener noreferrer"
          ...
          <a
            href="https://www.instagram.com/__shubh999__/?igsh=cXoybGo5M3J4a2E5#" // Your Instagram URL
            target="_blank"
            rel="noopener noreferrer"
        ...
        {/* Copyright and Personal Portfolio */}
        <p className="text-sm sm:text-base">
          &copy; {new Date().getFullYear()} Weblynx. All rights reserved.
        </p>
        <p className="mt-1 text-xs sm:text-sm">
          <a
            href="https://www.shubhampawale.info" // Your Personal Portfolio URL
            target="_blank"
            rel="noopener noreferrer"
